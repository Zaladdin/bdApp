...
- **📸 Галерея фотографий**: Загрузка и просмотр фотографий с облачным хранением
- **☁️ Облачное хранение**: Интеграция с Cloudinary для надежного хранения файлов
...
## ☁️ Настройка облачного хранения

Приложение поддерживает автоматическое сохранение фотографий в облаке через Cloudinary:

1. **Регистрация**: Создайте бесплатный аккаунт на [cloudinary.com](https://cloudinary.com)
2. **Получение ключей**: Скопируйте Cloud Name, API Key и API Secret из Dashboard
3. **Настройка**: Добавьте переменные окружения (см. [CLOUDINARY_SETUP.md](CLOUDINARY_SETUP.md))

**Преимущества:**
- 🆓 25GB бесплатного хранилища
...
2. Настройте переменные окружения (включая Cloudinary)
